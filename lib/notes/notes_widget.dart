                        ...
                        child: Row(
                          ...
                          children: [
                            ClipRRect(
                              borderRadius: BorderRadius.circular(5),
                              child: Image.asset(
                                'assets/images/kyle-glenn-nXt5HtLmlgE-unsplash.jpg',
                                width: 90,
                                height: 90,
                                fit: BoxFit.cover,
                              ),
                            ...
                            Padding(
                              padding:
                                  EdgeInsetsDirectional.fromSTEB(0, 0, 4, 4),
                              child: InkWell(
                                onTap: () async {
                                  await Navigator.push(
                                    context,
                    ...
                    child: Row(
                      ...
                      children: [
                        ClipRRect(
                          borderRadius: BorderRadius.circular(5),
                          child: Image.asset(
                            'assets/images/180601-atomi-mn-1540.jpg',
                            width: 90,
                            height: 90,
                            fit: BoxFit.cover,
                          ),
                    ...
                    child: Row(
                      ...
                      children: [
                        ClipRRect(
                          borderRadius: BorderRadius.circular(5),
                          child: Image.asset(
                            'assets/images/alex-kondratiev-yS3XM9qx3hQ-unsplash.jpg',
                            width: 90,
                            height: 90,
                            fit: BoxFit.cover,
                          ),
                    ...
                    child: Row(
                      ...
                      children: [
                        ClipRRect(
                          borderRadius: BorderRadius.circular(5),
                          child: Image.asset(
                            'assets/images/mr-cup-fabien-barral-Fo5dTm6ID1Y-unsplash.jpg',
                            width: 90,
                            height: 90,
                            fit: BoxFit.cover,
                          ),
